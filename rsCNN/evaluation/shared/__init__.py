from rsCNN.evaluation.shared.figures \
    import get_figure_and_grid, plot_figures_iterating_through_samples_features_responses
from rsCNN.evaluation.shared.subplots \
    ...
    plot_raw_predictions, plot_transformed_predictions, plot_softmax, plot_weights
